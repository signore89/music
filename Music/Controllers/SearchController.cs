...
namespace Music.Controllers
{
    public class SearchController : Controller
    {
        ...
        public async Task<IActionResult> Index(string query, string searchType = "albums", int page = 1)
        {
            ...
            {
                var albumsQuery = await _albumRepository.SearchByNameAsync(query);
            ...
            {
                var artistsQuery = await _artistRepository.SearchByNameAsync(query);
            ...
            {
                var songsQuery = await _songRepository.SearchByNameAsync(query);
